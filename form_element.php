...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/form_element by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:34:26 GMT -->
...
<script>
        function confirmcreateserveyor(event, form) {
            ...
            Swal.fire({
                title: "Are you sure?",
                text: "Please Confirm to create a Sub Admin!",
                icon: "warning",
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "php/createsubadmins.php",
                        data: $(form).serialize(), // Serialize the form data
                        success: function(response) {
                            if (response === "success") {
                                Swal.fire("Created!", "New Sub Admin Registered Successfully.",
                                    "success").then(() => {
                                    location.reload();
                                });
                            } else {
                                Swal.fire("Error", "Failed to Register New Sub Admin.", "error");
                            }
                        },
                        error: function(xhr, status, error) {
                            console.log("AJAX Error: " + error); // Log the error to the console
                            Swal.fire("Error",
                                "Failed to Register New Sub Admin. Please check the console for more details.",
                                "error");
                        },
                    });
                }
...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/form_element by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:34:27 GMT -->
</html>