...
include('php/get_avail_insulator.php');
?>
...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/noui_slider by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:34:20 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <link href="public/assets/vendor/nouislider/nouislider.min.css" rel="stylesheet" type="text/css" />
...
***********************************-->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Insulation Team list</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example" class="display min-w850">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>ID Status</th>
                                                <th>ID Control</th>
                                                <th>Insulator Phone</th>
                                                <th>Password</th>
                                                <th>Pwd</th>
                                                <th>About Insulator</th>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        buttons.forEach(button => {
            button.addEventListener("click", function() {
                const insulatorEmail = this.getAttribute("data-insulator");
                ...
                data.append("insulatorEmail", insulatorEmail);
                data.append("newStatus", newStatus);

                // Send the AJAX request to a PHP script
                fetch("php/update_insulatorstatus.php", {
                        method: "POST",
                        body: data
                    })
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        document.getElementById("password-change-button").addEventListener("click", function() {
            ...
            // Send the AJAX request to a PHP script
            fetch("php/change_insulatorpwd.php", {
                    method: "POST",
                    body: data
                })
                .then(response => response.text())
...
***********************************-->
    ...
    <script src="public/assets/vendor/wnumb/wNumb.js"></script>
    <script src="public/assets/js/plugins-init/nouislider-init.js"></script>
...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/noui_slider by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:34:22 GMT -->
