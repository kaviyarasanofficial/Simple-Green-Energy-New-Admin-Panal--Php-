...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/accordion by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:34:12 GMT -->
<!-- Added by HTTrack -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">New Installation Team Register</h4>
                            </div>
                            <div class="card-body">
        ...
        function confirmcreateserveyor(event, form) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "php/createinstallationteam.php",
                        data: $(form).serialize(), // Serialize the form data
                        success: function(response) {
                            if (response === "success") {
                                Swal.fire("Created!", "New Installation Team Registered Successfully.",
                                    "success").then(() => {
                                    location.reload();
                                });
                            } else {
                                Swal.fire("Error", "Failed to Register New Installation Team.", "error");
                            }
                        },
