...
include('php/get_all_gasengineers.php');
?>
...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/morris by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:34:08 GMT -->
<!-- Added by HTTrack -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Gas Engineer Works</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example" class="display min-w850">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Feedback Work</th>
                                                <th>ID Status</th>
                                                <th>Gas Engineer Phone</th>
                                                <th>Password</th>
                                                <th>About Gas Engineer</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $record["gasengineername"] ?></td>
                                                <td><?= $record["gasengineeremail"] ?></td>
                                                ...
                                                <td><?= $record["gasengineerphone"] ?></td>
                                                <td><?= $record["password"] ?></td>
                                                <td><?= $record["about_gasengineer"] ?></td>
                                            </tr>
                                            <?php endforeach; ?>
...
***********************************-->
    ...
    <script src="public/assets/js/plugins-init/morris-init.js"></script>
...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/morris by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:34:09 GMT -->
