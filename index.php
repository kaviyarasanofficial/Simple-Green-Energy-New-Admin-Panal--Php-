...
$sql = "SELECT COUNT(*) AS subadmins_count FROM teams WHERE role = 'Sub_Admin'";
$result = $conn->query($sql);
...
$sql = "SELECT COUNT(*) AS Gasengineers_count FROM teams WHERE role = 'Gas_engineers'";
$result = $conn->query($sql);
...
$sql = "SELECT COUNT(*) AS Installationteam_count FROM teams WHERE role = 'Installation_team'";
$result = $conn->query($sql);
...
$sql = "SELECT COUNT(*) AS Insulationteam_count FROM teams WHERE role = 'Insulation_team'";
$result = $conn->query($sql);
...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/index by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:32:27 GMT -->
<!-- Added by HTTrack -->
						...
						<div class="card featuredMenu">
							...
							<div class="card-body loadmore-content height700 dz-scroll pt-0" id="FeaturedMenusContent">
								<div class="media mb-4">
									<img src="public/assets/images/menus/1.png" width="85" alt="" class="rounded me-3">
									<div class="media-body">
										<h5><a href="food_menu.php" class="text-black fs-16">Chinese Orange Fruit With Avocado Salad</a></h5>
								...
								<div class="media mb-4">
									<img src="public/assets/images/menus/2.png" width="85" alt="" class="rounded me-3">
									<div class="media-body">
										<h5><a href="food_menu.php" class="text-black fs-16">Fresh or Frozen (No Sugar Added) Fruits</a></h5>
								...
								<div class="media mb-4">
									<img src="public/assets/images/menus/3.png" width="85" alt="" class="rounded me-3">
									<div class="media-body">
										<h5><a href="food_menu.php" class="text-black fs-16">Fresh or Frozen (No Sugar Added) Fruits</a></h5>
								...
								<div class="media mb-4">
									<img src="public/assets/images/menus/4.png" width="85" alt="" class="rounded me-3">
									<div class="media-body">
										<h5><a href="food_menu.php" class="text-black fs-16">Original Boiled Egg with Himalaya Salt</a></h5>
							...
							<div class="card-footer style-1 text-center border-0 pt-0 pb-4">
								<a class="text-primary dz-load-more fa fa-chevron-down" aria-label="Featured-icon" id="FeaturedMenus" href="javascript:void(0);" rel="public/assets/ajax/featured-menu-list.php">
								</a>
							</div>
						</div>
					</div>
...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/index by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:33:12 GMT -->
