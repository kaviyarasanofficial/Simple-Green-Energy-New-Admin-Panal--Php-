...
include('gasengineer_php/userleads.php');
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="display min-w850">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <input type="hidden" value="<?= $record["gasengineeremail"] ?>">
                                                <td><?= $record["workconfirmation"] ?></td>
                                                <td><button style="background-color: #0d6efd; border: none;"
                                                        class="status-button"
                                                        data-surveyoremail="<?= $record["gasengineeremail"] ?>"><i
                ...
                document.addEventListener("DOMContentLoaded", function() {
                    ...
                    buttons.forEach(button => {
                        button.addEventListener("click", function() {
                            ...
                            fetch("php/gasengineer_response.php", {
                                    method: "POST",
                                    body: data
                                })
