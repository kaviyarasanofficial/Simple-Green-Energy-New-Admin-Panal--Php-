...
include('php/get_avail_gasengineer.php');
?>
...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/chartjs by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:34:09 GMT -->
<!-- Added by HTTrack -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Gas Engineers list</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><button style="background-color: #0d6efd; border: none;" class="status-button"
                                                        data-gasengineer="<?= $record["email"] ?>"><i
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            buttons.forEach(button => {
                button.addEventListener("click", function() {
                    const gasengineerEmail = this.getAttribute("data-gasengineer");
                    ...
                    data.append("gasengineerEmail", gasengineerEmail);
                    data.append("newStatus", newStatus);

                    // Send the AJAX request to a PHP script
                    fetch("php/update_gasengineerstatus.php", {
                            method: "POST",
                            body: data
                        })
...
<script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById("password-change-button").addEventListener("click", function() {
                ...
                // Send the AJAX request to a PHP script
                fetch("php/change_gasengineerpwd.php", {
                        method: "POST",
                        body: data
                    })
                    .then(response => response.text())
...
***********************************-->
    ...
    <script src="public/assets/js/plugins-init/chartjs-init.js"></script>
