...
include('php/get_avail_Installaters.php');
?>
...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/badge by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:34:13 GMT -->
<!-- Added by HTTrack -->
...
***********************************-->
	...
	Content body start
***********************************-->
        <div class="content-body badge-demo default-height">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Installation Team list</h4>
                            </div>
                            <div class="card-body">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            buttons.forEach(button => {
                button.addEventListener("click", function() {
                    const installerEmail = this.getAttribute("data-installer");
                    ...
                    data.append("installerEmail", installerEmail);
                    data.append("newStatus", newStatus);

                    // Send the AJAX request to a PHP script
                    fetch("php/update_installerstatus.php", {
                            method: "POST",
                            body: data
                        })
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById("password-change-button").addEventListener("click", function() {
                ...
                // Send the AJAX request to a PHP script
                fetch("php/change_installerpwd.php", {
                        method: "POST",
                        body: data
                    })
                    .then(response => response.text())
