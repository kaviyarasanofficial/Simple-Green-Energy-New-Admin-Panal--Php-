...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/index_2 by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:33:30 GMT -->
					...
					<div class="col-xl-12">
						<div class="card featuredMenu">
							...
							<div class="card-footer style-1 text-center border-0 pt-0 pb-4">
								<a class="text-primary dz-load-more fa fa-chevron-down" id="FeaturedMenus" href="javascript:void(0);" rel="public/assets/ajax/featured-menu-list.php">
								</a>
							</div>
						</div>
					</div>
