...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/media_object by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:34:13 GMT -->
...
<div class="content-body default-height">
	<div class="container-fluid">
		...
		<div class="page-titles">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="javascript:void(0)">Bootsrap</a></li>
				...
				<div class="card">
					...
					<div class="card-body">
						<div class="bootstrap-media">
							<div class="media">
								<img class="me-3 img-fluid " width="60"  src="public/assets/images/avatar/1.jpg" alt="Vertical Media">
								<div class="media-body">
							...
							<div class="media mt-4">
								<img class="me-3 img-fluid " width="60"  src="public/assets/images/avatar/7.jpg" alt="Vertical Media">
								<div class="media-body">
									<h5 class="mt-0">Media heading</h5>
									<p class="mb-0">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
								</div>
			...
			<div class="col-xl-6 col-lg-12">
				<div class="card">
					...
					<div class="card-body">
						<div class="bootstrap-media">
							<div class="media">
								<img class="me-3 " width="60"  src="public/assets/images/avatar/2.jpg" alt="Vertical Media">
								<div class="media-body">
									<h5 class="mt-0">Media heading</h5>
									<p class="mb-0">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
									...
									<div class="media mt-4">
										<a class="pe-3" href="#">
											<img class="" width="60" src="public/assets/images/avatar/3.jpg" alt="Vertical Media">
										</a>
										<div class="media-body">
											<h5 class="mt-0">Media heading</h5>
											<p class="mb-0">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
			...
			<div class="col-xl-6 col-lg-12">
				<div class="card">
					...
					<div class="card-body">
						<div class="bootstrap-media">
							<div class="media">
								<img class="align-self-start me-3 " width="60"  src="public/assets/images/avatar/4.jpg" alt="Vertical Media">
								<div class="media-body">
			...
			<div class="col-xl-6 col-lg-12">
				<div class="card">
					...
					<div class="card-body">
						<div class="bootstrap-media">
							<div class="media">
								<img class="align-self-center me-3 " width="60"  src="public/assets/images/avatar/5.jpg" alt="Vertical Media">
								<div class="media-body">
			...
			<div class="col-xl-6 col-lg-12">
				<div class="card">
					...
					<div class="card-body">
						<div class="bootstrap-media">
							<div class="media">
								<img class="align-self-end me-3 " width="60"  src="public/assets/images/avatar/6.jpg" alt="Vertical Media">
								<div class="media-body">
					...
					<div class="card-body">
						<div class="bootstrap-media">
							<div class="media">
								...
								<img class="ms-3 " width="60"  src="public/assets/images/avatar/7.jpg" alt="Vertical Media">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card-body">
						<div class="bootstrap-media">
							<ul class="list-unstyled">
								<li class="media">
									<img class="me-3 " width="60"  src="public/assets/images/avatar/8.jpg" alt="Vertical Media">
									<div class="media-body">
								...
								<li class="media my-4">
									<img class="me-3 " width="60"  src="public/assets/images/avatar/1.jpg" alt="Vertical Media">
									<div class="media-body">
										<h5 class="mt-0">List-based media object</h5>
										<p class="mb-0">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus. vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
									</div>
...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/media_object by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:34:14 GMT -->
</html>