...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/dropdown by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:34:20 GMT -->
			...
			<div class="col-xl-6 col-lg-12">
				<div class="card">
					<div class="card-header d-block">
						...
						<p class="m-0 subtitle">Trigger dropdown menus at the right of the elements by adding
							<code>.dropstrat </code> to the parent element</p>
					</div>
					<div class="card-body">
