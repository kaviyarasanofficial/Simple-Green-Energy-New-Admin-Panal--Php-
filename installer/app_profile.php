...
include('php/get_user_details.php');
?>
...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/app_profile by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:33:21 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <link href="public/assets/vendor/lightgallery/dist/css/lightgallery.css" rel="stylesheet" type="text/css" />

    <link href="public/assets/vendor/lightgallery/dist/css/lg-thumbnail.css" rel="stylesheet" type="text/css" />

    <link href="public/assets/vendor/lightgallery/dist/css/lg-zoom.css" rel="stylesheet" type="text/css" />
    ...
    <style>
    .photo-content .cover-photos {
        background: url(https://content.app-sources.com/s/40460189946594834/uploads/Blog_Images/Save_Money_With_Green_Energy_1-5170796.jpg?format=webp);
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-bs-toggle="dropdown">
                                    ...
                                    <div class="header-info">
                                        ...
                                        <p class="fs-12 mb-0">Installation Team</p>
                                    </div>
                                </a>
...
***********************************-->
        <div class="deznav">
            ...
            <div class="copyright">
                <p><strong>Simple Green Energy Installation Team Dashboard</strong> © 2023 All Rights Reserved</p>
                    ...
                    <div class="profile card card-body px-3 pt-3 pb-0">
                        <div class="profile-head">
                            <div class="photo-content">
                                <div class="cover-photos"></div>
                            </div>
                            <div class="profile-info">
                                <div class="profile-photo">
                                    <img src="public/assets/images/profile/17.png" class="img-fluid rounded-circle"
                                        alt="">
                                </div>
                                <div class="profile-details">
                                    ...
                                    <div class="profile-email px-2 pt-2">
                                        <h4 class="text-muted mb-0"><?php echo $userEmail; ?></h4>
                                        <p>Gas Engineer</p>
                                    </div>
                                    <div class="dropdown ms-auto">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li class="dropdown-item"><a href="javascript:void(0);"
                                                    class="text-danger"><i class="fa fa-ban text-danger me-2"></i>
                                                    Block</a></li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="col-xl-4">
                    <div class="card h-auto">
                        <div class="card-body">
                            <div class="profile-statistics mb-5">
                                <div class="text-center">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <a href="javascript:void()" class="btn btn-primary mb-1" data-bs-toggle="modal"
							...
							<h4 class="text-primary d-inline">Today Highlights</h4><a href="javascript:void()" class="pull-right f-s-16">More</a>
							<img src="public/assets/images/profile/1.jpg" alt="" class="img-fluid mt-4 mb-4 rounded w-100">
							<h4><a href="post_details.php" class="text-black">Darwin Creative Agency Theme</a></h4>
						...
						<div class="profile-interest mb-5">
							...
							<div class="row mt-3 sp4" id="lightgallery">
								<a href="public/assets/images/profile/2.jpg" data-exthumbimage="https://gymove.dexignzone.com/codeigniter/demo/public/assets/images/profile/2.jpg" data-src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/images/profile/2.jpg" class="lg-item mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
									<img src="public/assets/images/profile/2.jpg" alt="" class="img-fluid rounded">
								</a>
								<a href="public/assets/images/profile/img9.jpg" data-exthumbimage="https://gymove.dexignzone.com/codeigniter/demo/public/assets/images/profile/img9.jpg" data-src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/images/profile/img9.jpg" class="lg-item mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
									<img src="public/assets/images/profile/img9.jpg" alt="" class="img-fluid rounded">
								</a>
								<a href="public/assets/images/profile/4.jpg" data-exthumbimage="https://gymove.dexignzone.com/codeigniter/demo/public/assets/images/profile/4.jpg" data-src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/images/profile/4.jpg" class="lg-item mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
									<img src="public/assets/images/profile/4.jpg" alt="" class="img-fluid rounded">
								</a>
								<a href="public/assets/images/profile/3.jpg" data-exthumbimage="https://gymove.dexignzone.com/codeigniter/demo/public/assets/images/profile/3.jpg" data-src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/images/profile/3.jpg" class="lg-item mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
									<img src="public/assets/images/profile/3.jpg" alt="" class="img-fluid rounded">
								</a>
								<a href="public/assets/images/profile/img10.jpg" data-exthumbimage="https://gymove.dexignzone.com/codeigniter/demo/public/assets/images/profile/img10.jpg" data-src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/images/profile/img10.jpg" class="lg-item mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
									<img src="public/assets/images/profile/img10.jpg" alt="" class="img-fluid rounded">
								</a>
								<a href="public/assets/images/profile/2.jpg" data-exthumbimage="https://gymove.dexignzone.com/codeigniter/demo/public/assets/images/profile/2.jpg" data-src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/images/profile/2.jpg" class="lg-item mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
									<img src="public/assets/images/profile/2.jpg" alt="" class="img-fluid rounded">
								</a>
						...
						<div class="profile-news">
							...
							<div class="media pt-3 pb-3">
								...
								<div class="media-body">
									<h5 class="m-b-5"><a href="post_details.php" class="text-black">Transform Yourself, Conquer Limits.</a></h5>
							...
							<div class="media pt-3 pb-3">
								...
								<div class="media-body">
									<h5 class="m-b-5"><a href="post_details.php" class="text-black">Elevate Fitness, Ignite Potential, Achieve.</a></h5>
							...
							<div class="media pt-3 ">
								...
								<div class="media-body">
									<h5 class="m-b-5"><a href="post_details.php" class="text-black">Strength, Endurance, Progress: Unleash"</a></h5>
                                    ...
                                    <div class="tab-content">
                                        <div id="my-posts" class="tab-pane fade active show">
                                            <div class="my-post-content pt-3">
                                                <div class="post-input">
                                                    ...
                                                    <a href="javascript:void()" class="btn btn-primary light me-1 px-3"
												...
												<img src="public/assets/images/profile/8.jpg" alt="" class="img-fluid rounded">
												<a class="post-title" href="post_details.php"><h3 class="text-black">Empower Your Fitness Journey Today.</h3></a>
											...
											<div class="profile-uoloaded-post border-bottom-1 pb-5">
												<img src="public/assets/images/profile/9.jpg" alt="" class="img-fluid rounded">
												<a class="post-title" href="post_details.php"><h3 class="text-black">Unlocking Your Fitness Journey's Details.</h3></a>
												<p>A wonderful serenity has take possession of my entire soul like these sweet morning of spare which enjoy whole heart.A wonderful serenity has take possession of my entire soul like these sweet morning
													of spare which enjoy whole heart.</p>
												<button class="btn btn-primary me-2"><span class="me-2"><i
															class="fa fa-heart"></i></span>Like</button>
											...
											<div class="profile-uoloaded-post pb-3">
												<img src="public/assets/images/profile/8.jpg" alt="" class="img-fluid rounded">
												<a class="post-title" href="post_details.php"><h3 class="text-black">Exploring Gym Essentials and Updates.</h3></a>
												<p>A wonderful serenity has take possession of my entire soul like these sweet morning of spare which enjoy whole heart.A wonderful serenity has take possession of my entire soul like these sweet morning
													of spare which enjoy whole heart.</p>
												<button class="btn btn-primary me-2"><span class="me-2"><i
															class="fa fa-heart"></i></span>Like</button>
                                        ...
                                        <div id="about-me" class="tab-pane fade">
                                            ...
                                            <div class="profile-lang  mb-5">
                                                ...
                                                <a href="javascript:void()" class="text-muted pe-3 f-s-16"><i
...
***********************************-->
    <footer class="footer">
        <div class="copyright">
            <p>Copyright © Designed &amp; Developed by <a href="http://dexignzone.com/" target="_blank">Vertical
                    Media</a> 2023</p>
        </div>
    </footer>
    <!--**********************************
...
***********************************-->
    ...
    <script src="public/assets/vendor/lightgallery/dist/lightgallery.min.js"></script>
    <script src="public/assets/vendor/lightgallery/dist/plugins/thumbnail/lg-thumbnail.min.js"></script>
    <script src="public/assets/vendor/lightgallery/dist/plugins/zoom/lg-zoom.min.js"></script>
...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/app_profile by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:33:29 GMT -->
