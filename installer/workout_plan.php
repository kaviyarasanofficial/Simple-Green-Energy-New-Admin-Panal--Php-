...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/workout_plan by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:33:31 GMT -->
						...
						<div class="card plan-list">
							<div class="card-header d-sm-flex flex-wrap d-block pb-0 border-0">
								...
								<div class="card-action card-tabs me-4 mt-3 mt-sm-0 mb-3">
									<ul class="nav nav-tabs" role="tablist">
										...
										<li class="nav-item">
											<a class="nav-link active" data-bs-toggle="tab" href="#Unifinshed" role="tab" aria-selected="true">Unifinshed</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" data-bs-toggle="tab" href="#Finished" role="tab">Finished</a>
										</li>
									</ul>
								</div>
							...
							<div class="card-body tab-content pt-2">
								<div class="tab-pane active show fade" id="Unifinshed">
									<div class="d-flex border-bottom flex-wrap pt-3 list-row align-items-center mb-2 px-3">
										<div class="col-xl-5 col-xxl-8 col-lg-6 col-sm-8 d-flex align-items-center">
											...
											<div class="info mb-3">
												<h4 class="fs-20 "><a href="workout_statistic.php" class="text-black">Routine Cardio Burn Workout</a></h4>
												<span class="text-danger font-w600">UNFINISHED</span>
											</div>
										</div>
										<div class="col-xl-2 col-xxl-4 col-lg-2 col-sm-4 activities mb-3 me-auto ps-3 pe-3 text-sm-center text-xl-end">
											...
											<span class="text-warning ms-2">Running</span>
										</div>
										<div class="col-xl-5 col-xxl-12 col-lg-4 col-sm-12 d-flex align-items-center">
											<a href="javascript:void(0);" class="btn mb-3 play-button rounded me-3"><i class="las la-caret-right scale-2 me-3"></i>Start Workout</a>
									...
									<div class="d-flex border-bottom flex-wrap pt-3 list-row align-items-center mb-2 px-3">
										<div class="col-xl-5 col-xxl-8 col-lg-6 col-sm-8 d-flex align-items-center">
											...
											<div class="info mb-3">
												<h4 class="fs-20 "><a href="workout_statistic.php" class="text-black">Total Body Yoga Workout </a></h4>
										...
										<div class="col-xl-2 col-xxl-4 col-lg-2 col-sm-4 activities mb-3 me-auto ps-3 pe-3 text-sm-center text-xl-end">
											...
											<span class="text-secondary ms-2">Yoga</span>
										</div>
										<div class="col-xl-5 col-xxl-12 col-lg-4 col-sm-12 d-flex align-items-center">
											<a href="javascript:void(0);" class="btn mb-3 play-button rounded me-3"><i class="las la-caret-right scale-2 me-3"></i>Set Finish</a>
											<div class="dropdown mb-3">
												<a href="javascript:void(0)" class="more-button" data-bs-toggle="dropdown" aria-expanded="false">
													<svg width="6" height="26" viewBox="0 0 6 26" fill="none" xmlns="http://www.w3.org/2000/svg">
														<path d="M6 3C6 4.65685 4.65685 6 3 6C1.34315 6 0 4.65685 0 3C0 1.34315 1.34315 0 3 0C4.65685 0 6 1.34315 6 3Z" fill="#585858"></path>
									...
									<div class="d-flex border-bottom flex-wrap pt-3 list-row align-items-center mb-2 px-3">
										...
										<div class="col-xl-2 col-xxl-4 col-lg-2 col-sm-4 activities mb-3 me-auto ps-3 pe-3 text-sm-center text-xl-end">
											...
											<span class="text-info ms-2">Cycling</span>
										</div>
										<div class="col-xl-5 col-xxl-12 col-lg-4 col-sm-12 d-flex align-items-center">
											<a href="javascript:void(0);" class="btn mb-3 play-button rounded me-3"><i class="las la-caret-right scale-2 me-3"></i>Start Workout</a>
											<div class="dropdown mb-3">
									...
									<div class="d-flex border-bottom flex-wrap pt-3 list-row align-items-center mb-2 px-3">
										<div class="col-xl-5 col-xxl-7 col-lg-6 col-sm-7 d-flex align-items-center">
											<div class="list-icon bg-light me-3 mb-3">
												<p class="fs-24 text-black mb-0 mt-2">28</p>
												<span class="fs-14 text-black">Fri</span>
											</div>
											<div class="info mb-3">
												<h4 class="fs-20 "><a href="workout_statistic.php" class="text-black">Weekly Routine Cycling</a></h4>
												<span class="text-primary font-w600">Finished</span><span class="ps-3 pe-3">34Km</span><span>00:23:45”</span>
											</div>
										</div>
										<div class="col-xl-2 col-xxl-3 col-lg-2 col-sm-3 activities mb-3 me-auto ps-3 pe-3 text-sm-center text-xl-end col-6">
											<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<div class="d-flex border-bottom flex-wrap pt-3 list-row align-items-center mb-2 px-3">
										<div class="col-xl-5 col-xxl-7 col-lg-6 col-sm-7 d-flex align-items-center">
											...
											<div class="info mb-3">
												<h4 class="fs-20 "><a href="workout_statistic.php" class="text-black">2020 Runner Event Workout</a></h4>
												<span class="text-primary font-w600">Finished</span><span class="ps-3 pe-3">34Km</span><span>00:23:45”</span>
											</div>
										</div>
										<div class="col-xl-2 col-xxl-3 col-lg-2 col-sm-3 activities mb-3 me-auto ps-3 pe-3 text-sm-center text-xl-end col-6">
									...
									<div class="d-flex flex-wrap pt-3 list-row align-items-center px-3">
										<div class="col-xl-5 col-xxl-7 col-lg-6 col-sm-7 d-flex align-items-center">
											<div class="list-icon bg-light me-3 mb-3">
											...
											<div class="info mb-3">
												<h4 class="fs-20 "><a href="workout_statistic.php" class="text-black">Daily Running Workout</a></h4>
												<span class="text-primary font-w600">Finished</span><span class="ps-3 pe-3">34Km</span><span>00:23:45”</span>
											</div>
										</div>
										<div class="col-xl-2 col-xxl-3 col-lg-2 col-sm-3 activities mb-3 me-auto ps-3 pe-3 text-sm-center text-xl-end col-6">
				...
				<div class="row">	
					<div class="col-xl-12">
						<div class="card flex-xl-column flex-md-row flex-column">
							...
							<div class="card-body">
								<h4 class="text-black mb-4">Next week plan</h4>
								<div class="d-flex mb-4 align-items-center">
									<span class="date-icon me-3">3</span>
									<div>
										<h6 class="fs-16"><a href="workout_statistic.php" class="text-black">Cardio Exercise</a></h6>
										<span class="fs-14">12 Sets | 16mins</span>
									</div>
								</div>
								<div class="d-flex mb-4 align-items-center">
									<span class="date-icon me-3">5</span>
									<div>
										<h6 class="fs-16"><a href="workout_statistic.php" class="text-black">Cycling Routine</a></h6>
										<span class="fs-14">20Km target distances</span>
									</div>
								</div>
								<div class="d-flex align-items-center">
									<span class="date-icon me-3">16</span>
									<div>
										<h6 class="fs-16"><a href="workout_statistic.php" class="text-black">Cycling Routine</a></h6>
										<span class="fs-14">20Km target distances</span>
									</div>
...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/workout_plan by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:33:32 GMT -->
</html>