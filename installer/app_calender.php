...
include('installer_php/userleads.php');
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="display min-w850">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <input type="hidden" value="<?= $record["installateremail"] ?>">
                                                <td><?= $record["workconfirmation"] ?></td>
                                                <td><button style="background-color: #0d6efd; border: none;"
                                                        class="status-button"
                                                        data-surveyoremail="<?= $record["installateremail"] ?>"><i
                                                        class="hvr-buzz-out la la-rocket"
                                                        style="color:white;"></i></button>
                                                </td>
                                                <td><?= $record["installateremail"] ?></td>
                ...
                document.addEventListener("DOMContentLoaded", function() {
                    ...
                    buttons.forEach(button => {
                        button.addEventListener("click", function() {
                            ...
                            const newStatus = currentStatus === "Confirmed" ? "Rejected" :
                                "Confirmed";
                            ...
                            fetch("php/installer_response.php", {
                                    method: "POST",
                                    body: data
                                })
