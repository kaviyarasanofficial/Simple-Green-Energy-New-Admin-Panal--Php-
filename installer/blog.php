...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/blog by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:34:04 GMT -->
            ...
            <div class="col-xl-12">
                ...
                <div class="mb-5">
                    <ul class="d-flex align-items-center flex-wrap">
                        <li><a href="add_blog.php" class="btn btn-primary ">Add Blog</a></li>
                        <li><a href="blog_category.php" class="btn btn-primary mx-1">Blog Category</a></li>
                        <li><a href="blog_category.php" class="btn btn-primary mt-sm-0 mt-1">Add Blog Category</a></li>
                    </ul>
                </div>
                <div class="filter cm-content-box box-primary">
                    <div class="content-title">
