...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/card by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:34:14 GMT -->
...
<div class="content-body default-height">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-xl-6">
				<div class="card">
					...
					<div class="card-footer border-0 pt-0">
						...
						<a href="javascript:void()" class="card-link float-end">Card link</a>
					</div>
				</div>
			</div>
			<div class="col-xl-6">
			...
			<div class="col-xl-6">
				<div class="card text-white  card-ui-default-1 bg-primary">
					<div class="card-header">
			...
			<div class="col-xl-6">
				<div class="card text-white card-ui-default-1 bg-secondary">
					<div class="card-header">
			...
			<div class="col-xl-6">
				<div class="card text-white card-ui-default-1 bg-success">
					<div class="card-header">
			...
			<div class="col-xl-6">
				<div class="card text-white card-ui-default-1  bg-danger">
					<div class="card-header">
			...
			<div class="col-xl-6">
				<div class="card text-white card-ui-default-1 bg-warning">
					<div class="card-header">
			...
			<div class="col-xl-6">
				<div class="card text-white bg-info card-ui-default-1">
					<div class="card-header">
			...
			<div class="col-xl-6">
				<div class="card bg-light card-ui-default-1">
					<div class="card-header">
						<h5 class="card-title text-black">Light card</h5>
					</div>
					<div class="card-body mb-0">
			...
			<div class="col-xl-6">
				<div class="card text-white card-ui-default-1 bg-dark">
					<div class="card-header">
			...
			<div class="col-xl-6">
				<div class="card mb-3">
					<img class="card-img-top img-fluid" src="public/assets/images/card/1.png" alt="Card image cap">
					<div class="card-header">
						<h5 class="card-title">Card title</h5>
					</div>
					<div class="card-body">
			...
			<div class="col-xl-6">
				<div class="card mb-3">
					<img class="card-img-top img-fluid" src="public/assets/images/card/2.png" alt="Card image cap">
					<div class="card-header">
						<h5 class="card-title">Card title</h5>
					</div>
					<div class="card-body">
			...
			<div class="col-xl-6">
				<div class="card mb-3">
					...
					<img class="card-img-bottom img-fluid rounded-0" src="public/assets/images/card/3.png" alt="Card image cap">
					<div class="card-footer">
						<p class="card-text d-inline">Card footer</p>
						<a href="javascript:void()" class="card-link float-end">Card link</a>
					</div>
...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/card by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:34:17 GMT -->
</html>