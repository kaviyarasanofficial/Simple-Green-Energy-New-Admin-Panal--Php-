...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/add_blog by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:34:04 GMT -->
...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&amp;family=Roboto:wght@100;300;400;500;700;900&amp;display=swap" rel="stylesheet">
		 ...
		 <link href="public/assets/vendor/select2/css/select2.min.css" rel="stylesheet" type="text/css"/>	
		
		 <link href="public/assets/vendor/datatables/css/jquery.dataTables.min.css" rel="stylesheet" type="text/css"/>	
		
		 <link href="public/assets/vendor/tagify/tagify.css" rel="stylesheet" type="text/css"/>	
			...
			<div class="col-xl-12">
				<div class="mb-3">
					<ul class="d-flex align-items-center flex-wrap">
						<li><a href="add_email.php" class="btn btn-primary">Blog List</a></li>
						<li><a href="blog_category.php" class="btn btn-primary mx-1">Blog Category</a></li>
						<li><a href="blog_category.php" class="btn btn-primary me-1 mt-sm-0 mt-1">Add Blog Category</a></li>
										...
										<div class="avatar-upload d-flex align-items-center">
											<div class=" position-relative ">
												<div class="avatar-preview">
													<div id="imagePreview" style="background-image: url(public/assets/images/no-img-avatar.png);"> 			
													</div>
												</div>
...
***********************************-->        
	        ...
	        <script src="public/assets/vendor/tagify/tagify.js"></script>
...
$("#imageUpload").on('change',function() {
	...
	$('.remove-img').on('click', function() {
		var imageUrl = "public/assets/images/no-img-avatar.png";
...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/add_blog by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:34:05 GMT -->
</html>