...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/ecom_customers by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:33:54 GMT -->
                    ...
                    <form id="updateForm" class="row" method="post" action="leadupdates.php">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class=" input-left-icon">
                                    <select class="form-control" id="heatingSource" name="heatingSource"
                                        value="<?= $row['heatingSource']; ?>">
                                        <option value="Gas bolier"
                                            <?= ($row['heatingSource'] === 'Gas bolier') ? 'selected' : '' ?>>Gas bolier
                                        </option>
                                        <option value="Back boiler"
                                            <?= ($row['heatingSource'] === 'Back boiler') ? 'selected' : '' ?>>Back
                                            boiler</option>
                                        <option value="Electric heaters"
                                            <?= ($row['heatingSource'] === 'Electric heaters') ? 'selected' : '' ?>>
                                            Electric heaters</option>
                                        <option value="No Heating present"
                                            <?= ($row['heatingSource'] === 'Back Boiler') ? 'selected' : '' ?>>No
                                            Heating present</option>
                                    </select>
                           ...
                           <label for="fuleType">Fuel Type</label>
                            ...
                            <input type="text" class="form-control" id="boilerType" name="boilerType" value="<?= $row['boilerType']; ?>"> -->
                                ...
                                <div class="icon-addon addon-md input-left-icon">
                                    <select class="form-control" id="isHeatingSourceOld" name="isHeatingSourceOld"
                                        value="<?= $row['isHeatingSourceOld']; ?>">
                                        <option value="1" <?= ($row['isHeatingSourceOld'] === '1') ? 'selected' : '' ?>>
                                            Yes</option>
                                        <option value="0" <?= ($row['isHeatingSourceOld'] === '0') ? 'selected' : '' ?>>
                                            No</option>
                            ...
                            <input type="text" class="form-control" id="boilerCondition" name="boilerCondition" value="<?= $row['boilerCondition'] ?>"> -->
                                ...
                                <div class="icon-addon addon-md input-left-icon">
                                    <select class="form-control" id="propertyOwnership" name="propertyOwnership"
                                        value="<?= $row['propertyOwnership'] ?>">
                                        <option value="Own"
                                            <?= ($row['propertyOwnership'] === 'Own') ? 'selected' : '' ?>>Own</option>
                                        <option value="Rent"
                                            <?= ($row['propertyOwnership'] === 'Rent') ? 'selected' : '' ?>>Rent
                                        </option>
                            ...
                            <input type="text" class="form-control" id="isWallMounted" name="isWallMounted" value="<?= $row['isWallMounted'] ?>"> -->
                                ...
                                <div class="icon-addon addon-md input-left-icon">
                                    <select class="form-control" id="benefit" name="benefit"
                                        value="<?= $row['benefit'] ?>">
                                        <option value="Job seekers allowance"
                                            <?= ($row['benefit'] === 'Job seekers allowance') ? 'selected' : '' ?>>Job
                                            seekers allowance</option>
                                        <option value="Employment and support allowance"
                                            <?= ($row['benefit'] === 'Employment and support allowance') ? 'selected' : '' ?>>
                                            Employment and support allowance</option>
                                        <option value="income support"
                                            <?= ($row['benefit'] === 'income support') ? 'selected' : '' ?>>Income
                                            support</option>
                                        <option value="Pension credit guarantee"
                                            <?= ($row['benefit'] === 'Pension credit guarantee') ? 'selected' : '' ?>>
                                            Pension credit guarantee</option>
                                        <option value="Working tax credit"
                                            <?= ($row['benefit'] === 'Working tax credit') ? 'selected' : '' ?>>Working
                                            tax credit</option>
                                        <option value="Child tax credit"
                                            <?= ($row['benefit'] === 'Child tax credit') ? 'selected' : '' ?>>Child tax
                                            credit</option>
                                        <option value="Universal credit"
                                            <?= ($row['benefit'] === 'Universal credit') ? 'selected' : '' ?>>Universal
                                            credit</option>
                                        <option value="Housing benefit"
                                            <?= ($row['benefit'] === 'Housing benefit') ? 'selected' : '' ?>>Housing
                                            benefit</option>
                                        <option value="Pension Credit savings credit"
                                            <?= ($row['benefit'] === 'Pension Credit savings credit') ? 'selected' : '' ?>>
                                            Pension Credit savings credit</option>
                                        <option value="Child Benefit"
                                            <?= ($row['benefit'] === 'Child Benefit') ? 'selected' : '' ?>>Child Benefit
                                        </option>
                                        <option value="Low Income/Health Condition"
                                            <?= ($row['benefit'] === 'Low Income/Health Condition') ? 'selected' : '' ?>>
                                            Low Income/Health Condition</option>
                                        <option value="No Benefits"
                                            <?= ($row['benefit'] === 'No Benefits') ? 'selected' : '' ?>>No Benefits
                                        </option>
                                    </select>
                                    <label  title="email"></label>
                                </div>
                                ...
                                <div class="icon-addon addon-md input-left-icon">
                                    <select class="form-control" id="property" name="property"
                                        ...
                                        <option value="Detached House"
                                            <?= ($row['property'] === 'Detached House') ? 'selected' : '' ?>>Detached
                                            House</option>
                                        <option value="Semi-Detached House"
                                            <?= ($row['property'] === 'Semi-Detached House"') ? 'selected' : '' ?>>
                                            Semi-Detached House"</option>
                                        <option value="End-Terrance House"
                                            <?= ($row['property'] === 'End-Terrance House') ? 'selected' : '' ?>>
                                            End-Terrance House</option>
                                        <option value="Mid-Terrance House"
                                            <?= ($row['property'] === 'Mid-Terrance House') ? 'selected' : '' ?>>
                                            Mid-Terrance House</option>
                                        <option value="Bungalow"
                                            <?= ($row['property'] === 'Bungalow') ? 'selected' : '' ?>>Bungalow</option>
                                        <option value="Park Home"
                                            <?= ($row['property'] === 'Park Home') ? 'selected' : '' ?>>Park Home
                                        </option>
                                        <option value="Flat" <?= ($row['property'] === 'Flat') ? 'selected' : '' ?>>Flat
                                        </option>
                                    </select>
                                    <label  title="email"></label>
                                </div>
                                ...
                                <div class="icon-addon addon-md input-left-icon">
                                    <select class="form-control" id="bedroom" name="bedroom"
                                        ...
                                        <option value="1 Bedroom"
                                            <?= ($row['bedroom'] === '1 Bedroom') ? 'selected' : '' ?>>1 Bedroom
                                        </option>
                                        <option value="2 Bedrooms"
                                            <?= ($row['bedroom'] === '2 Bedrooms') ? 'selected' : '' ?>>2 Bedrooms
                                        </option>
                                        <option value="3 Bedrooms"
                                            <?= ($row['bedroom'] === '3 Bedrooms') ? 'selected' : '' ?>>3 Bedrooms
                                        </option>
                                        <option value="4 Bedrooms"
                                            <?= ($row['bedroom'] === '4 Bedrooms') ? 'selected' : '' ?>>4 Bedrooms
                                        </option>
                                        <option value="5 Bedrooms"
                                            <?= ($row['bedroom'] === '5 Bedrooms') ? 'selected' : '' ?>>5 Bedrooms
                                        </option>
                                        <option value="6+ Bedrooms"
                                            <?= ($row['bedroom'] === '6+ Bedrooms') ? 'selected' : '' ?>>6+ Bedrooms
                                        </option>
                            ...
                            <input type="text" class="form-control" id="propertyType" name="propertyType" value="<?= $row['wall'] ?>"> -->
                                ...
                                <div class="icon-addon addon-md input-left-icon">
                                    <select class="form-control" id="wall" name="wall" value="<?= $row['wall'] ?>">
                                        <option value="Soild Brick Walls"
                                            <?= ($row['wall'] === 'Soild Brick Walls') ? 'selected' : '' ?>>Soild Brick
                                            Walls</option>
                                        <option value="Cavity Walls"
                                            <?= ($row['wall'] === 'Cavity Walls') ? 'selected' : '' ?>>Cavity Walls
                                        </option>
                                        <option value="Not Sure" <?= ($row['wall'] === 'Not Sure') ? 'selected' : '' ?>>
                                            Not Sure</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="fno" class="form-control" id="fuleType" name="fuleType"
                                    value="<?= $row['f.no'] ?>" readonly>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <button type="submit" style="margin-left:5px;" class="btn btn-primary " id="updateRecord">Update Record</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/ecom_customers by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:33:56 GMT -->
</html>