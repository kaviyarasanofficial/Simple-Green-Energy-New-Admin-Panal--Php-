...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/widget_basic by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:34:26 GMT -->
		...
		<div class="row">
							...
							<ul class="timeline">
								<li>
									<div class="timeline-panel">
										...
										<div class="media-body">
											<h5 class="mb-1">Instr. sultads Send you Photo</h5>
											<small class="d-block">29 July 2020 - 02:26 PM</small>
										</div>
										<div class="dropdown">
							...
							<ul class="timeline">
								...
								<li>
									...
									<div class="timeline-panel">
										...
										<div class="media-body">
											<h5 class="mb-1">Instr. sultads Send you Photo <span class="badge light badge-danger">Danger</span></h5>
											<small class="d-block">29 July 2020 - 02:26 PM</small>
										</div>
										<div class="dropdown">
											<button type="button" class="btn btn-primary light sharp" data-bs-toggle="dropdown">
								...
								<li>
									<div class="timeline-panel">
										...
										<div class="media-body">
											...
											<p class="mb-1">I shared this on my fb wall a few months..</p>
					...
					<div class="col-xl-3 col-lg-6 col-sm-6">
						<div class="widget-stat card bg-warning overflow-hidden">
							<div class="card-header border-0 ">
								<h3 class="card-title text-white">New Clients</h3>
					...
					<div class="card-body pb-0">
						...
						<ul class="list-group list-group-flush">
							...
							<li class="list-group-item d-flex px-0 justify-content-between">
								...
								<span class="mb-0"> Exercise Science</span>
							</li>
							<li class="list-group-item d-flex px-0 justify-content-between">
								<strong>Designation</strong>
								<span class="mb-0">Fitness instructors</span>
							</li>
							<li class="list-group-item d-flex px-0 justify-content-between">
								<strong>Training program gym</strong>
			...
			<div class="col-xl-4 col-lg-6 col-xxl-4 col-sm-6">
				<div class="card text-white bg-primary">
					<ul class="list-group list-group-flush">
						<li class="list-group-item d-flex justify-content-between"><span class="mb-0">Diet type :</span><strong>A+</strong></li>
						<li class="list-group-item d-flex justify-content-between"><span class="mb-0">Breakfast :</span><strong>Penicilin, peanuts </strong></li>
						<li class="list-group-item d-flex justify-content-between"><span class="mb-0">Mid Morning :</span><strong>Banana Apple</strong></li>
						<li class="list-group-item d-flex justify-content-between"><span class="mb-0">Lunch :</span><strong>4 Roti Dal</strong></li>
						<li class="list-group-item d-flex justify-content-between"><span class="mb-0">Dinner :</span><strong>Red Meat</strong></li>
					</ul>
				</div>
			</div>
			<div class="col-xl-4 col-lg-6 col-xxl-4 col-sm-6">
				<div class="card text-white bg-warning text-black">
					<ul class="list-group list-group-flush">
						<li class="list-group-item d-flex justify-content-between"><span class="mb-0">Workout Schedule</span></li>
						<li class="list-group-item d-flex justify-content-between"><span class="mb-0">Monday :</span><strong>Chest</strong></li>
						<li class="list-group-item d-flex justify-content-between"><span class="mb-0">Tuesday :</span><strong>lats</strong></li>
						<li class="list-group-item d-flex justify-content-between"><span class="mb-0">Wednesday :</span><strong>Shoulder</strong></li>
						<li class="list-group-item d-flex justify-content-between"><span class="mb-0">Thursday:</span><strong>Abs</strong></li>
					</ul>
				</div>
			</div>
