...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/personal_record by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:33:42 GMT -->
		...
		<div class="row">
						...
						<div class="row align-items-center">
							<div class="col-xl-5 col-xxl-12 me-auto">
								<div class="d-sm-flex d-block align-items-center">
									<img src="public/assets/images/illustration.png" alt="" class="mw-100 me-3">
									<div>
							...
							<div class="col-xl-7 col-xxl-12 mt-3">
								<a href="workout_plan.php" class="btn btn-outline-primary btn-md mb-2">May 28th, 2020<i class="las la-calendar ms-3 scale5"></i></a>
								...
								<a href="workout_plan.php" class="btn btn-outline-primary me-3 btn-md  mb-2">June 28th, 2020<i class="las la-calendar ms-3 scale5"></i></a>
								<a href="workout_plan.php" class="btn btn-primary btn-md mb-2">Generate Report<i class="las la-angle-right ms-3 scale5"></i></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="card">
					<div class="card-header bg-white">
						<div class="d-flex me-3 align-items-center">
							<span class="p-sm-3 p-2 me-sm-3 me-2 rounded-circle bg-secondary">
					...
					<div class="card-body p-0">
						<div class="table-responsive">
							<table class="table bg-transparent shadow-hover">
								<thead>
									<tr>
								...
								<tbody>
									<tr>
										<td>
											<p class="text-black mb-1">Sunday</p>
											<span class="fs-14">September 2, 2020</span>
										</td>
										<td>
											<p class="text-black mb-1">14,2 Km</p>
											<span class="fs-14">Target 15Km</span>
										</td>
										<td>
											<p class="text-black mb-1">00:53:22”</p>
											<span class="fs-14">Target 40mins</span>
										</td>
									</tr>
									<tr>
										<td>
											<p class="text-black mb-1">Monday</p>
									...
									<tr>
										<td>
											<p class="text-black mb-1">Tuesday</p>
									...
									<tr>
										<td>
											<p class="text-black mb-1">Wednesday</p>
									...
									<tr>
										<td>
											<p class="text-black mb-1">Thursday</p>
									...
									<tr>
										<td>
											<p class="text-black mb-1">Friday</p>
									...
									<tr>
										<td>
											<p class="text-black mb-1">Saturday</p>
											<span class="fs-14">September 8, 2020</span>
										</td>
										<td>
											<p class="text-black mb-1">14,2 Km</p>
			...
			<div class="col-xl-4 col-xxl-6 col-lg-6">
				<div class="card">
					<div class="card-header bg-white">
						<div class="d-flex me-3 align-items-center">
							<span class="p-sm-3 p-2 me-sm-3 me-2 rounded-circle bg-danger">
				...
				<div class="card">
					<div class="card-header bg-white">
						<div class="d-flex align-items-center me-3">
							<span class="p-sm-3 p-2 me-sm-3 me-2 rounded-circle bg-warning">
								<svg width="32" height="32" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
