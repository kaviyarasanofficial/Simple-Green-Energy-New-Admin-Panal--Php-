...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/sweetalert by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:34:22 GMT -->
...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&amp;family=Roboto:wght@100;300;400;500;700;900&amp;display=swap" rel="stylesheet">
		 ...
		 <link href="public/assets/vendor/sweetalert2/dist/sweetalert2.min.php" rel="stylesheet" type="text/css"/>	
	...
	<style>
    .panel-body {
        /* Style for the container of the dropzone */
        padding: 20px;
    ...
    .dropzone input[type="file"] {
        /* Style for the input file element within the dropzone */
        display: none;
    }

    /* Styles for when files are dragged over the dropzone */
    .dropzone.dragover {
        border-color: #33adff;
        background-color: #e6f7ff;
    }

    /* Styles for the fallback area */
    .fallback {
        /* Style for the fallback area if JavaScript isn't available */
        margin-top: 20px;
        text-align: center;
    }
                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-bd lobidrag">
                            ...
                            <div class="panel-body">
                                <p class="m-b-15">Upload customer documents here; they are stored in the uploads folder.
                                    Then, the history displays the document's History Section and checks.</p>
...
***********************************-->        
	        ...
	        <script src="public/assets/vendor/sweetalert2/dist/sweetalert2.min-2.php"></script>
            <script src="public/assets/js/plugins-init/sweetalert.init.js"></script>
...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/sweetalert by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:34:23 GMT -->
</html>