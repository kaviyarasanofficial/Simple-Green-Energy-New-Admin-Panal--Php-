...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/content by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:33:59 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <link href="public/assets/vendor/jquery-smartwizard/dist/css/smart_wizard.min.css" rel="stylesheet"
        type="text/css" />
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response === "success") {
                                Swal.fire("Created!", "New Surveyor Registered Successfully.",
                                    "success").then(() => {
                                    location.reload();
                                });
                            } else {
                        ...
                        error: function(xhr, status, error) {
                            ...
                            Swal.fire("Error",
                                "Failed to Register New Surveyor. Please check the console for more details.",
                                "error");
                        },
                    });
                }
