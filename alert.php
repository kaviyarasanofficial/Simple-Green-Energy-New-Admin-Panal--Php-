...
include('php/get_all_installationteam.php');
?>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Installation Works</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example" class="display min-w850">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Feedback Work</th>
                                                <th>ID Status</th>
                                                <th>Installater Phone</th>
                                                <th>Password</th>
                                                <th>About Installater</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $record["installaterphone"] ?></td>
                                                <td><?= $record["password"] ?></td>
                                                <td><?= $record["about_installater"] ?></td>
                                            </tr>
                                            <?php endforeach; ?>
