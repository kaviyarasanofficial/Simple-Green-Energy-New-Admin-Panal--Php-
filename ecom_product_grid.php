                            ...
                            <table id="example" class="display min-w850">
                                ...
                                <tbody>
                                    <?php foreach ($records as $record): ?>
													...
													<td><?= $record["f.no"] ?></td>
													<td>
															<div class="dropdown ms-auto text-end c-pointer" style="z-index: 1000;">
																<div class="btn-link" data-bs-toggle="dropdown" data-bs-popper="static" data-bs-placement="top">
