                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Boiler Leads</h4>
                            </div>
                            <div class="card-body">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <form action="work_process.php" method="post">
                                                                ...
                                                                <button type="submit" class="dropdown-item"
                                                                    ...
                                                                    <i class="fa fa-calendar text-danger me-2"></i> Work
                                                                    Process Update
                                                                </button>
                                                            </form>
                                                            <button type="button" class="dropdown-item notify-button"
                                                                ...
                                                                <i class="fa fa-bell text-info me-2"></i> Notify
                                                            </button>
                                                            ...
                                                            <button type="button"
                                                                ...
                                                                data-email="<?= $record["email"] ?>"
                                                                data-record-id="<?= $record["f.no"] ?>">
                                                                <i class="fa fa-heart text-success me-2"></i> Approve
                                                            </button>
                                                            <button type="button" class="dropdown-item status-button"
                                                                data-email="<?= $record["email"] ?>"
                                                                data-record-id="<?= $record["f.no"] ?>">
                                                                <i class="fa fa-ban text-danger me-2"></i> Reject
                                                            </button>
                                                        </div>
                                                    </div>
                                                </td>
