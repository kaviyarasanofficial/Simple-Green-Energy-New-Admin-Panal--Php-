...
include('php/get_all_insulationteam.php');
?>
...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/nestable by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:34:20 GMT -->
<!-- Added by HTTrack -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Insulation  Works</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example" class="display min-w850">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $record["insulatorname"] ?></td>
                                                <td><?= $record["insulatoremail"] ?></td>
                                                ...
                                                <td><?= $record["insulatorphone"] ?></td>
                                                <td><?= $record["password"] ?></td>
                                                <td><?= $record["about_insulator"] ?></td>
                                            </tr>
                                            <?php endforeach; ?>
