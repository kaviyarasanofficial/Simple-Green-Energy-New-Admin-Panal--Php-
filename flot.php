...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/flot by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:34:05 GMT -->
<!-- Added by HTTrack -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">New Gas Engineers Register</h4>
                            </div>
                            <div class="card-body">
        ...
        function confirmcreateserveyor(event, form) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "php/creategasengineer.php",
                        data: $(form).serialize(), // Serialize the form data
                        success: function(response) {
                            if (response === "success") {
                                Swal.fire("Created!", "New Gas Engineer Registered Successfully.",
                                    "success").then(() => {
                                    location.reload();
                                });
                            } else {
                                Swal.fire("Error", "Failed to Register New Gas Engineer.", "error");
                            }
                        },
                        error: function(xhr, status, error) {
                            console.log("AJAX Error: " + error); // Log the error to the console
                            Swal.fire("Error",
                                "Failed to Register New Gas Engineer. Please check the console for more details.",
                                "error");
                        },
                    });
                }
...
***********************************-->
    ...
    <script src="public/assets/js/plugins-init/flot-init.js"></script>
...
<!-- Mirrored from gymove.dexignzone.com/codeigniter/demo/flot by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:34:08 GMT -->
